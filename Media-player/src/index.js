...
// Button binding
// document.getElementById('always_on_top_btn').addEventListener('clicked',()=>{
//   getData();
// })
...
// function getData(){
//   document.getElementById('always_on_top_btn').classList.remove('always_on_top_btn').add('pressed_top');
// }

// $('#always_on_top_btn').on({
//  click: function(){
//     $(this).css("background-image","url(../ui/always_on_top_active_bl_03.png)");
...
// })
function change(){
  document.getElementById("always_on_top_btn").style.backgroundImage = "url(../ui/always_on_top_active_bl_03.png)";
}
// $("#always_on_top_btn").on("click",()=>{
//   console.log($("#always_on_top_btn").css("background-image"));
// })
